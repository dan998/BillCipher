...
def back():
    print()
    back = input('\033[92mDo you want to continue with the Coding family? [Yes/No]: ')
    if back[0].upper() == 'Y':
        print()
        iseeverything()
    elif back[0].upper() == 'N':
        print('\033[92mRemember to support http://danmaffiayounghack.blogspot.com/')
        exit
    else:
        print('\033[92m?')
        exit
...
def iseeverything():
    try:
        ...
        if choose == '1':
            ...
            clear()
            os.system('cd modules/passive-subd && bash passive-subd.sh '+victim)
            back()
...
AUTHOR: http://danmaffiayounghack.blogspot.com/
        ...
        print('The information you entered is wrong mother fucker')
        print()
        iseeverything()
